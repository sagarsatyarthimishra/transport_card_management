...
export default function TransactionsPage() {
  ...
  // ============================================================
  // Card search keyboard navigation
  // ============================================================
  ...
  //
  // IMPORTANT:
  // Newest entry is added at the TOP.
  // ============================================================
  ...
  // Total
  //
  // Total remains based on ALL drafts,
  // not only filtered search results.
  // ============================================================
  ...
  async function downloadGeneratedFile(
    ...
    try {
      ...
      const fileName =
        fileNameMatch?.[1] ??
        `transport_transactions.${extension}`;
  ...
  //
  // IMPORTANT:
  // This calls generate ONLY ONCE.
  // It does not call /api/transactions separately.
  //
  // Therefore no duplicate transactions.
  // ============================================================
...
/**
 * Small icon component used for empty preview state.
 */
