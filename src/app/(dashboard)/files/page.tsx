...
export default function FilesPage() {
  ...
  //
  // Search is debounced.
  // Date and page-size changes refresh the list.
  // ============================================================
  ...
  //
  // IMPORTANT:
  // MMM and SDH have separate transaction pages.
  // ============================================================
  ...
  function handleEditFile(
    ...
    if (
      ...
      router.push(
        `/transaction?fileId=${encodedFileId}`,
      );
    ...
    router.push(
      `/transactions?fileId=${encodedFileId}`,
    );
  }
  ...
  async function handleDownload(
    ...
    try {
      ...
      if (
        ...
        throw new Error(
          `${format.toUpperCase()} file is empty.`,
        );
      }
                          ...
                          <td className="px-5 py-4">
                            ...
                            <div className="flex justify-end gap-2">
                              ...
                              <Button
                                ...
                                title="Edit file"
                                className="border-slate-200 text-slate-700 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700"
                              >
