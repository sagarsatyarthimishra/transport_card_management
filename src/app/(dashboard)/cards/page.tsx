...
export default function CardsPage() {
   ...
   *
   * Search is controlled by the debounced `search` state,
   * not directly by every keyboard event.
   */
   ...
   * 1234
   *
   * but only ONE request is made after typing stops.
   */
  useEffect(() => {
  ...
  async function handleAddCard(
    ...
    try {
      ...
      console.error("Add card error:", saveError);
  ...
  async function handleExport() {
    try {
      ...
      anchor.href = url;
      anchor.download = "transport_cards.xlsx";
      ...
      <div className="mb-7 flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <Button
            ...
            disabled={
              isExporting || pagination.total === 0
            }
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1.5 text-sm leading-6 text-slate-500">
                    ...
                    from your card master. This action
                    cannot be undone.
                  </p>
                </div>
              </div>
